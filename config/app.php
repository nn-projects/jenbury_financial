...
return [
    ...
    'Email' => [
        'default' => [
            'transport' => 'default',
            'from' => 'noreply@jenburyfinancial.com',
            /*
    ...
    'Session' => [
        'defaults' => 'php',
        'timeout' => 300, // The time in minutes a session can be idle before expiring.
    ],
    ...
    'Recaptcha' => [
        'siteKey' => '6Le6-PkqAAAAAGbV4yyBT9E1bnJ_oXOG79BHm8Y1',
        'secretKey' => '6Le6-PkqAAAAABZT1bXSo612kggOfmh7J11RUmFu',
    ],

    /*
     * Stripe Configuration
     *
     * Load API keys and webhook secret from environment variables.
     */
    'Stripe' => [
