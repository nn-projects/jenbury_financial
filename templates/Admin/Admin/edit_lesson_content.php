<?php
/**
 * Jenbury Financial - Admin Edit Lesson Content Page
 */
$this->assign('title', 'Edit Lesson Content');
$this->Html->css(['admin/_edit-lesson-content'], ['block' => true]); // Added CSS link
?>

<div class="edit-lesson-content-page admin-edit-page"> <?php // Added page wrapper class ?>

    <header class="admin-page-header">
        <h1>Edit Lesson: <?= h($content->title) ?></h1>
        <div class="admin-back-link">
            <?= $this->Html->link('‹ Back to Manage Contents',
                ['action' => 'manageContents', $content->module_id],
                ['class' => 'button', 'escape' => false]
            ) ?>
        </div>
    </header>
    <?php // Removed old breadcrumbs and page-header divs ?>
    ...
    <div class="admin-form-container admin-content-card"> <?php // Standardized container ?>
        <div class="admin-card-body"> <?php // Standardized body ?>
            <?= $this->Form->create($content, ['type' => 'post', 'id' => 'editContentForm', 'novalidate' => true]) ?>
            <fieldset>
                <legend><?= __('Lesson Details') ?></legend> <?php // Added legend ?>
                <?= $this->Form->control('title', [
                    'label' => 'Lesson Content Title',
                    'required' => true,
                    'class' => 'form-input', // Standardized class
                    // 'style' => 'font-size: 2em;', // Removed inline style
                    'maxlength' => 255
                ]) ?>
...
</div> <?php // Close edit-lesson-content-page ?>
...
<?php // Removed potential trailing CDATA marker if it was there ?>
